...
const PlaylistCard = ({ playlist }) => {
  ...
  return (
    <div
      className="card card-side bg-base-100 shadow-md mb-4 max-w-md hover:cursor-pointer hover:bg-base-200 transition duration-300 ease-in-out overflow-hidden"

const MobileWrapper = ({ children }) => {
    return (
        <div 
            className="w-full h-screen place-items-center bg-neutral-100 overflow-x-hidden"
            style={{
        ...
        >
            <div className="min-h-screen mx-4 my-10 overflow-y-auto  flex flex-col items-center justify-center">
                {children}
            </div>
        </div>
    );

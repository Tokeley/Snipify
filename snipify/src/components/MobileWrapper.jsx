const MobileWrapper = ({ children }) => {
    return (
        <div 
            className="w-full h-full place-items-center bg-neutral-100 overflow-x-hidden"
            style={{
        ...
        >
            <div className="h-full mx-4 my-6 sm:my-10 overflow-y-auto  flex flex-col items-center justify-center">
                {children}
            </div>
        </div>
    );
